...
class Flux2VAE(torch.nn.Module):
    ...
    def encode(
        ...
        tiled: bool = False, tile_size: int = 512, tile_stride: int = 256,
    ):
        """
        ...
        Args:
            ...
            tiled (`bool`, *optional*, defaults to `False`):
                Whether to use tiled encoding to reduce memory usage.
            tile_size (`int`, *optional*, defaults to `512`):
                The size of each tile in pixels. Only used when `tiled=True`.
            tile_stride (`int`, *optional*, defaults to `256`):
                The stride between tiles in pixels. Only used when `tiled=True`.
        ...
        """
        if tiled:
            prev_use_tiling = self.use_tiling
            prev_tile_sample_min_size = self.tile_sample_min_size
            prev_tile_latent_min_size = self.tile_latent_min_size
            prev_tile_overlap_factor = self.tile_overlap_factor
            self.use_tiling = True
            self.tile_sample_min_size = tile_size
            self.tile_latent_min_size = tile_size // 8
            self.tile_overlap_factor = 1.0 - tile_stride / tile_size
        ...
        if tiled:
            self.use_tiling = prev_use_tiling
            self.tile_sample_min_size = prev_tile_sample_min_size
            self.tile_latent_min_size = prev_tile_latent_min_size
            self.tile_overlap_factor = prev_tile_overlap_factor
