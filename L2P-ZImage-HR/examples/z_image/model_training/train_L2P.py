...
def z_image_parser():
    ...
    parser.add_argument(
        "--height_division_factor", type=int, default=64,
        help="Pixel size must be divisible by this. Use the DiT patch size: 64 (4K) / 128 (8K) / 160 (10K).",
    )
    parser.add_argument(
        "--width_division_factor", type=int, default=64,
        help="Pixel size must be divisible by this. Use the DiT patch size: 64 (4K) / 128 (8K) / 160 (10K).",
    )
    return parser
