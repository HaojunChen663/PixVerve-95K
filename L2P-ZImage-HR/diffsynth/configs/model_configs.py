...
z_image_L2P_series = [
    # L2P pixel-space DiT, three resolutions share the same ZImageDiT class.
    # The loader matches a checkpoint by its key/shape hash and instantiates
    # ZImageDiT(**extra_kwargs); `all_patch_size` selects the 4K/8K/10K U-Net.
    {
        # 4K (4096x4096), patch_size=64
        "model_hash": "69e8fd5b562ea858b9f864508c1263b3",
        "model_name": "z_image_dit_L2P",
        "model_class": "diffsynth.models.z_image_dit_L2P.ZImageDiT",
        "extra_kwargs": {"all_patch_size": (64,)},
    },
    {
        # 8K (8192x8192), patch_size=128
        "model_hash": "df0e4e865d39501e2fe96c7ea8aa40f6",
        "model_name": "z_image_dit_L2P",
        "model_class": "diffsynth.models.z_image_dit_L2P.ZImageDiT",
        "extra_kwargs": {"all_patch_size": (128,)},
    },
    {
        # 10K (10240x10240), patch_size=160
        "model_hash": "e6094ba663b7c10011eb47db072ead0b",
        "model_name": "z_image_dit_L2P",
        "model_class": "diffsynth.models.z_image_dit_L2P.ZImageDiT",
        "extra_kwargs": {"all_patch_size": (160,)},
    },
    {
        # Example: ModelConfig(model_id="Tongyi-MAI/Z-Image-Turbo", origin_file_pattern="text_encoder/*.safetensors")
        "model_hash": "0f050f62a88876fea6eae0a18dac5a2e",
