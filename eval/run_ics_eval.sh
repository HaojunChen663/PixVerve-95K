...
GEN_DIR=""                                              # Modify this to your actual directory containing generated images
MODEL_PATH="/z_pretrained/Qwen3.5-35B-A3B"              # Modify this to your actual Qwen3.5-35B-A3B model path
OUTPUT_DIR=""                                           # Directory to save evaluation results (JSONL, CSV, and logs)
API_URL="http://127.0.0.1:8000/v1"                      # Modify this to your actual API address and port
CONCURRENCY=8                                           # Adjust based on your hardware capability  
